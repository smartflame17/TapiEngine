...
const char* CustomBehaviour::GetInspectorTitle() const noexcept
{
	return scriptName.empty() ? "Custom Behaviour" : scriptName.c_str();
}

void CustomBehaviour::DrawInspectorContents() noexcept
{
